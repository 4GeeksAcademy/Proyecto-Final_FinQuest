...
export const ChildSmallGoals = ({ onBack, onNextStep }) => {
    // 1. Catálogo de "Caprichos" o Privilegios (Sugerencias)
    ...
    // Función para crear el premio personalizado
    const addNewReward = () => {
    ...
    return (
        <div className="card shadow-lg border-0 p-4 w-100 h-100 d-flex flex-column" 
            ...
            {/* Estilo para limpiar flechas de inputs numéricos */}
            <style>
                {`
            ...
            <div className="d-flex gap-2 mb-4 align-items-center">
                <input 
                    ...
                    placeholder="Nuevo premio (ej. Ir al cine)"
                    value={newRewardName}
                    onChange={(e) => setNewRewardName(e.target.value)}
                />

                {/* Recuadro de monedas de 140px (exactamente como en Tareas) */}
            ...
            <div className="overflow-auto mb-3 pe-2" style={{ maxHeight: "200px" }}>
                <p className="small fw-bold text-secondary text-start mb-2 uppercase">Sugerencias de premios</p>
                {suggestions.map((r) => (
            ...
            <div className="flex-grow-1 border-top pt-3 overflow-auto">
                ...
                {addedRewards.length === 0 && <p className="text-muted small italic text-start ms-3">Añade premios para motivar a tu castor</p>}
