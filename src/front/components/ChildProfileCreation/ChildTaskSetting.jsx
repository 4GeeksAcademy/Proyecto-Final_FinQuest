...
export const ChildTaskSetting = ({ onBack, onNextStep }) => {
    ...
    // Añadir tarea personalizada al catálogo
    ...
    // Alternar selección de días en el catálogo
    ...
    // Mover tarea del catálogo a la lista final
    ...
    // Devolver tarea de la lista final al catálogo
    ...
    return (
        <div className="card shadow-lg border-0 p-4 w-100 h-100 d-flex flex-column"
            ...
            <div className="d-flex gap-2 mb-4 align-items-center">
                ...
                {/* Recuadro de monedas compacto y limpio */}
            ...
            <div className="overflow-auto mb-3 pe-2" style={{ maxHeight: "230px" }}>
                <p className="small fw-bold text-secondary text-start mb-2 uppercase">Sugerencias (Configura y añade +)</p>
            ...
            <div className="flex-grow-1 border-top pt-3 overflow-auto">
                ...
                {addedTasks.length === 0 && <p className="text-muted small italic">Añade tareas arriba para que aparezcan aquí</p>}
